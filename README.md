...
- **Frontend** — React 18 + Vite 6 for the UI shells (start, end, pause, HUD), with the entire game simulation running on a raw HTML Canvas at 60fps. React renders the canvas once and hands it off; the game loop never triggers a re-render. Tailwind CSS 3 styles the UI screens.
